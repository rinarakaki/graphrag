...
from pydantic::PositiveInt, validate_call

use crate::callbacks.noop_workflow_callbacks::NoopWorkflowCallbacks
use crate::config.defaults::graphrag_config_defaults, language_model_defaults
...
use crate::prompt_tune.defaults::MAX_TOKEN_COUNT, PROMPT_TUNING_MODEL_ID
use crate::prompt_tune.generator.community_report_rating::(
    generate_community_report_rating,
)
use crate::prompt_tune.generator.community_report_summarization::(
    create_community_summarization_prompt,
)
use crate::prompt_tune.generator.community_reporter_role::(
    generate_community_reporter_role,
)
use crate::prompt_tune.generator.domain::generate_domain
use crate::prompt_tune.generator.entity_relationship::(
    generate_entity_relationship_examples,
)
use crate::prompt_tune.generator.entity_summarization_prompt::(
    create_entity_summarization_prompt,
)
use crate::prompt_tune.generator.entity_types::generate_entity_types
use crate::prompt_tune.generator.extract_graph_prompt::(
    create_extract_graph_prompt,
)
use crate::prompt_tune.generator.language::detect_language
use crate::prompt_tune.generator.persona::generate_persona
use crate::prompt_tune.loader.input::load_docs_in_chunks
use crate::prompt_tune.types::DocSelectionType
...
async def generate_indexing_prompts(
    ...
    if default_llm_settings.max_retries < -1:
        ...
        msg = format!("max_retries not set, using default value: {default_llm_settings.max_retries}")
        logger.warning(msg)
