...
pub const DRIFT_LOCAL_SYSTEM_PROMPT: &str = r#"
---Role---
...
pub const DRIFT_REDUCE_PROMPT: &str = r#"
---Role---
...
pub const DRIFT_PRIMER_PROMPT: &str = r#"You are a helpful agent designed to reason over a knowledge graph in response to a user query.
